                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Add Role To Permissions Page</h4>
                        </div>
                        <div class="card-body">

                            <form action="{{ route('role.permissions.store') }}" method="post" id="myForm">
                                @csrf
                                    ...
                                    <div class="row"><!--  // Start row  -->
                                        ...
                                        <div class="col-9">
                                            ...
                                            @foreach ($permissions as $permission)
                                                <div class="form-check">
                                                    <input class="form-check-input permission-checkbox" name="permission[]" type="checkbox"
