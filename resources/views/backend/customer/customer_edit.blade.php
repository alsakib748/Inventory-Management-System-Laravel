                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('customer.update') }}" method="post" id="myForm" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <input type="number" class="form-control" id="mobile_no" name="mobile_no" value="{{ $customer->mobile_no }}">
                                    </div>
                                </div>
                                ...
                                <center>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <img id="showImage" src="{{ asset($customer->customer_image) }}" class="rounded avatar-lg" alt="Card image cap">
                                        </div>
                                    </div>
